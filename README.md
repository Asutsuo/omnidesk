...
- Dashboard com resumo da rotina e progresso das atividades
- Cadastro, conclusão, filtragem e exclusão de prazos
- Timer Pomodoro com foco, pausa curta e pausa longa
- Criação e revisão interativa de flashcards
...
├── data.ts       # tipos e dados iniciais
└── index.css     # estilos e variáveis globais
```

## Armazenamento

Atualmente, o OmniDesk é uma aplicação front-end e salva as informações no `localStorage` do navegador. Por isso, os dados ficam vinculados ao dispositivo e ao navegador utilizados.
