...
import "./Header.css";
type HeaderProps = { title: string; subtitle: string; initials: string; avatar?: string; onMenu: () => void };
function Header({ title, subtitle, initials, avatar, onMenu }: HeaderProps) {
