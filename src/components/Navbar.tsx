import { BarChart3, BookOpen, Clock3, Home, Menu, Plus, Timer, UserRound, Users, X } from "lucide-react";
import "./Navbar.css";
export type PageId = "home" | "prazos" | "timer" | "flashcards" | "equipes" | "estatisticas" | "perfil";
const navItems = [{ id: "home", label: "Home", icon: Home }, { id: "prazos", label: "Prazos", icon: Clock3 }, { id: "timer", label: "Timer", icon: Timer }, { id: "flashcards", label: "Flashcards", icon: BookOpen }, { id: "equipes", label: "Equipes", icon: Users }, { id: "estatisticas", label: "Estatísticas", icon: BarChart3 }, { id: "perfil", label: "Perfil", icon: UserRound }] as const;
