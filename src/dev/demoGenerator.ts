...
export function generateDemoData(raw: DemoOptions, namespace = "preview"): AppData {
  ...
  if (options.profile === "empty") return normalizeData({ version: 6, onboarded: true, profile: { name: "Daniel", course: "Meu espaço de estudos", objective: "", weeklyGoal: 5 }, theme: "omnidesk" });
